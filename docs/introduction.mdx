...
Verdex has a Standard mode and an <Icon icon="tornado" iconType="duotone" /> **Expert** mode with more advanced features. 
...
<CardGroup cols={2}>
  <Card title="Vulnerabilities" icon="light-emergency-on" href="/expert/vulnerabilities">
